...
import type { IQuestionCQ, TData, TError, TMeta, TTag } from "../../../types";
...
const ActionBtn = ({ item }: { item: IQuestionCQ }) => {
    ...
    const deleteQuestionHandler = async () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (response?.data as TData<IQuestionCQ>) {
                    Swal.fire({
                        title: "Deleted!",
...
const CQQuestions = () => {
    ...
    const [questions, setQuestions] = useState<IQuestionCQ[]>([]);
    ...
    const { data, isSuccess, isFetching, isLoading } = getQuestionsQuery(
        searchParams ? [...searchParams, ["type", "CQ"]] : [["type", "CQ"]]
    );
