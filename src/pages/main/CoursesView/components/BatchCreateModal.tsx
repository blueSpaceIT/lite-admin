...
const BatchCreateModal = ({ courseID }: { courseID: string }) => {
    ...
    type TCreateBatchFromData = z.infer<
        typeof BatchResolvers.createBatchValidationSchema
    >;

    const [createBatch] = batchService.useCreateBatchMutation();

    const createBatchHandler = async (data: TCreateBatchFromData) => {
        setIsOpen(false);
                ...
                <div className="fixed inset-0 z-50 w-screen bg-black/40 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4">
                        ...
                        >
                            ...
                            <Form<TCreateBatchFromData>
                                onSubmit={createBatchHandler}
                                defaultValues={defaultValues}
                                resolver={zodResolver(
                                    BatchResolvers.createBatchValidationSchema
                                )}
                            >
                                <InputField
                                    name="name"
